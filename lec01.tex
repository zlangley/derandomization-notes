\chapter{The Class prBPP}
\label{lec:01}

\section{Promise Problems and prBPP}
...
\section{Equivalent Definitions of prBPP via Amplification}
...
\section{The Circuit Acceptance Probability Problem (CAPP)}
