...
\comment{What do we even need the above defition, theorem and corollary for? I'm not sure where we use it.}
...
\comment{TODO: Proof. This is where we need to be efficient vis-a-vis number of random coins.}
