...
\begin{proofsk}
  ...
  \begin{enumerate}
    ...
    \item Compute a list of circuits each implementing the LLDC decoder with
      ...
      \comment{This step makes no sense -- I just copied it from my notes.
      In particular, what exactly are we decoding?}
    ...
    \item Combine this with a local unique decoder.
      \comment{Again, I don't know why this step is here, don't we have
      the circuit we want already after the previous step?}
  \end{enumerate}
